...
На данный момент являюсь manual QA в компании "Атвинта".
...
✔️ Реализованы UI-автотесты для **_десктопной и мобильной_** версии веб-сайта "Askona".</br></br>
🚩Что особенного:
...
✔️ Реализованы UI-автотесты для десктопной версии онлайн-конструктора "Stellar Burger".</br></br>
🚩Что особенного:
- ✅ Page Object
- ✅ Автотесты написаны на "чистом" Selenium, без использования сторонних библиотек
...
<img src="/icons/pycharm.png" alt="pycharm" width="05%" />
<img src="/icons/requests.png" alt="requests" width="05%" />
<img src="/icons/logo.svg" alt="facker" width="05%" />
<img src="/icons/pytest.png" alt="pytest" width="05%" />

✔️ Реализованы автотесты Rest Api на проверку запросов *crud* онлайн-конструктора "Stellar Burger".</br>  
🚩 Что особенного:
...
- ✅ В Teadown автотеста происходит удаление тестовой сущности.

### _Unit-тесты_:
Протестированы низкоуровневые модули сервиса "Stellar Burger"  
<img src="icons/python.png" alt="Python" width="05%" />
<img src="/icons/pycharm.png" alt="pycharm" width="05%" />
<img src="/icons/pytest.png" alt="pytest" width="05%" />

✔️ Реализованы положительные/негативные проверки работы низкоуровневых модулей сервиса "Stellar Burger".</br>  
